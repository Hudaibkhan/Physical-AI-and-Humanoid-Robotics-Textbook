...
app = FastAPI(
    title="Book RAG Agent API with Authentication",
    description="API for the Book RAG Agent that uses OpenAI Agents SDK with Gemini 2.5 Flash and includes user authentication",
    version="1.0.0"
)
...
# Import the original chat functionality
...
@app.get("/")
async def root():
    return {"message": "Book RAG Agent API with Authentication is running"}
